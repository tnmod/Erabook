    ...
    <ScrollView style={{ backgroundColor: 'white', flex: 1 }}>
      <View style={[styles.container]}>
        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', }}>
          ...
          <Text style={[styles.text500, { marginLeft: 12, fontSize: 18 }]}>About EraBook</Text>
        </TouchableOpacity>
        <View style={[{ alignItems: 'center', marginVertical: 12, marginTop: 32 }]}>
          <Image style={{ width: 82, height: 82 }} source={require('../../assets/icon/main/main-icon.png')} />
          <Text style={[styles.text700, { fontSize: 18, marginTop: 12 }]}>Erabook v7.5.4</Text>
        </View>
